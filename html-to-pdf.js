...
@media print {
  html, body { -webkit-print-color-adjust: exact; print-color-adjust: exact; font-size: 10pt !important; line-height: 1.35 !important; }
  .container { display: grid !important; grid-template-columns: 1fr 1fr !important; grid-template-rows: auto auto auto auto auto !important; gap: 10pt 14pt !important; align-items: stretch !important; max-width: none !important; padding: 0 !important; }
  ...
  .contact-section, .profile-section, .skills-section, .languages-section { min-height: unset !important; }
  .contact-section .neonbox, .profile-section .neonbox, .skills-section .neonbox, .languages-section .neonbox { height: 100% !important; display: flex !important; flex-direction: column !important; }
  .contact-section .section, .profile-section .section, .skills-section .section, .languages-section .section { flex: 1 1 auto !important; display: flex !important; flex-direction: column !important; }
  .header-section, .contact-section, .profile-section, .skills-section, .languages-section, .projects-highlight, .experiences-section, .grid-item, .section, .neonbox { break-inside: avoid !important; page-break-inside: avoid !important; }
  h1, h2 { page-break-after: avoid !important; margin: 0 0 0.5rem 0 !important; background: none !important; -webkit-text-fill-color: inherit !important; }
  .top-right-buttons, #toggle, #lang-button, #print-btn, .lang-dropdown { display: none !important; }
  [data-theme="light"] body { background: #fff !important; color: #2c3e50 !important; }
  [data-theme="light"] .neonbox { background: #f8f9fa !important; border: 1px solid #dee2e6 !important; box-shadow: none !important; }
  [data-theme="light"] .contact-section .neonbox { background: #007BFF !important; color: #fff !important; border: none !important; }
  [data-theme="dark"] body { background: #1a1a1a !important; color: #f8f9fa !important; }
  [data-theme="dark"] .neonbox { background: #2c2c2c !important; border: 2px solid #444 !important; box-shadow: none !important; }
  [data-theme="dark"] .contact-section .neonbox { background: #007BFF !important; color: #fff !important; border: none !important; }
